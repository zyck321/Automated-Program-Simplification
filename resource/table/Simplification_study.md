| S/N | LINK | Simplification Type |
|:---:|:----:|:-------------------:|
|  1   |   https://github.com/s1ddh4rthc/testudo-bank/pull/17   |          extract(extract method)           |
|  2   | https://github.com/Multibit-Legacy/multibit-hd/pull/900     |         control stream(inline function return)            |
|   3  | https://github.com/ago1024/WurmServerModLauncher/pull/69     |          control stream(transform between switch and if;inline function return)/inline(inline variable)           |
| 4    |   https://github.com/DrKLO/Telegram/pull/1596   |       control stream(inline function return;reformat if else;use foreach for iteration)/use apis              |
|   5  |  https://github.com/TakahikoKawasaki/nv-websocket-client/pull/185    |          control stream(use foreach for iteration)/use apis           |
|  6   |  https://github.com/google/guava/pull/6015    |      lambda/java generics initialization/control stream(use foreach for iteration)               |
|  7   |   https://github.com/datastax/cassandra/pull/253   |          extract(extract method)           |
|   8  |   https://github.com/contiki-ng/cooja/pull/736   |       inline(inline method)              |
|   9  |   https://github.com/alibaba/fastjson/pull/3914   |       use apis              |
|  10   |   https://github.com/Scott-YuYan/spring-boot/pull/1   |       control stream(use foreach for iteration)/lambda              |
|  11   |   https://github.com/Fede5mentarios/full-stack-test-backend/pull/4   |         use annotations            |
|  12   |   https://github.com/airlift/aircompressor/pull/43   |      extract(extract method)               |
|   13  |   https://github.com/metrodroid/nfc-felica-lib/pull/2   |         delete            |
|  14   |   https://github.com/vincejv/fpi-bot-api/pull/36   |      extract(extract method)               |
|   15  |  https://github.com/adithyasolai/testudo-bank/pull/97    |     extract(extract method)                |
| 16    |   https://github.com/abhupadh/aio-lib-java/pull/1   |       delete              |
|  17   |   https://github.com/RosmaryFC/Meme-ify-Me-ARHM/pull/41   |       delete              |
|  18   |   https://github.com/traex/CalendarListview/pull/40   |       control stream(merge conditions;inline function return)              |
|   19  |   https://github.com/skiptests/astraea/pull/990   |         delete            |
|  20   |  https://github.com/DataLinkDC/dlink/pull/1163    |       use constructor to initialize              |
|  21   |   https://github.com/InformationCommunicationTechnology/ICT-4305/pull/18   |     control stream(java conditional expression simplification)                |
|   22  |  https://github.com/adewandaru/primetest/pull/2    |      control stream(inline function return;java conditional expression simplification)/use apis               |
|  23   |  https://github.com/edmunds/databricks-rest-client/pull/101    |     use apis                |
|  24   |  https://github.com/natsukry/wire-loc/pull/4    |       inline(inline variable)              |
|   25  |  https://github.com/CMSgov/AB2D-Libs/pull/122    |       lambda              |
|   26  |   https://github.com/contiki-ng/cooja/pull/572   |        control stream(inline function return;merge conditions)             |
|  27   |    https://github.com/dromara/hutool/pull/2594  |         use apis            |
|   28  |   https://github.com/apolloconfig/apollo/pull/4524   |        lambda             |
|   29  |   https://github.com/JorelAli/CommandAPI/pull/326   |       use constructor to initialize              |
| 30    |   https://github.com/dogtagpki/jss/pull/893   |     control stream(inline function return;java ternary conditional operator)/lambda/control stream(merge catch)/extract(extract variable)                |
|   31  |   https://github.com/kiegroup/kogito-runtimes/pull/2493   |    use apis/control stream(inline function return)                 |
|  32   |   https://github.com/alibaba/nacos/pull/8908   |        lambda             |
|  33  |    https://github.com/camunda-community-hub/spring-zeebe/pull/200  |         delete            |
|  34   |   https://github.com/benbenlaw/cosmopolis/pull/1   |       delete              |
|   35  |   https://github.com/bigdataviewer/bigdataviewer-playground/pull/207   |         control stream(merge conditions)            |
|   36  |  https://github.com/mybatis/mybatis-3/pull/2611    |      use apis               |
|   37  |   https://github.com/syndesisio/syndesis/pull/9616   |     inline(inline variable)                |
...
|   74  |   https://github.com/day0n/CSlab/pull/1   |        inline(inline variable)             |
...
|   111  |  https://github.com/openmrs/openmrs-core/pull/3724    |        use apis             |
...
|  148   |  https://github.com/Latestion/HideOrHunt-Bukkit/pull/3    |    java generics initialization/lambda/extract(extract variable)                 |
...
|  185   |  https://github.com/HawkAnticheat/Hawk/pull/52    |         use apis            |
...
|   222  |  https://github.com/goxr3plus/java-stream-player/pull/26    |   use apis/control stream(java conditional expression simplification;use foreach for iteration)                  |
...
|  259   |  https://github.com/fossasia/susi_server/pull/1174    |  lambda/control stream(inline function return)/extract(extract method)                   |
